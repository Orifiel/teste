...
function colorize() {
    const botao = document.querySelector('#button-red')
    botao.style.borderColor = getRandomColor() 
    //definindo a cor de fundo, usando a função getRandomColor
    botao.style.background = getRandomColor()
    botão.style.color = getRandomColor()
}